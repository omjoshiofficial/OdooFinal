<%@ Page Language="C#" AutoEventWireup="true" CodeFile="becomelib.aspx.cs" Inherits="UserSide_becomelib" %>
                    ...
                    <div class="wrap-login100">
                        <div class="login100-form validate-form">
                            ...
                            <div class="text-center p-t-27">
                                <a class="txt1" style="text-decoration: none;font-size:15px" href="loginLibrary.aspx">Go To Login Page</a>
                                <br />
                                <a class="txt1" style="text-decoration: none;font-size:15px" href="reglibrary.aspx">Go To Registration Page</a>
                            </div>
                        </div>
                    </div>
                </div>
